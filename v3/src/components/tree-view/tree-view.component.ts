...
export class TreeViewComponent implements OnInit, OnDestroy {
  ...
  setActive(event: Event, nodeId: string): void {
    event.stopPropagation(); // Prevents parent click events from firing
    this.menuStateService.setActiveNode(nodeId);
  }

  /*isActive Node State */
  isActive(nodeId:string):boolean{
    return this.menuStateService.isActive(nodeId);
  }
